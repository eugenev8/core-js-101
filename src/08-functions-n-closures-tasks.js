...
function memoize(func) {
  let result; // Store the cached result
  let isMemoized = false; // Track if the result is already memoized

  return function memo() {
    if (!isMemoized) {
      // If the result is not memoized, invoke the function and cache the result
      result = func();
      isMemoized = true;
    }
